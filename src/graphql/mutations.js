...
import { LOGGED_USER_DETAILS, QUESTION_DETAILS, COMMENT_DETAILS, ANSWER_DETAILS } from "./fragments";
...
export const EDIT_ANS_COMMENT = gql`
    mutation updateAnsComment($quesId: ID!, $ansId: ID!, $commentId: ID! , $body: String!) {
      editAnsComment(quesId: $quesId, ansId: $ansId, commentId: $commentId,
        body: $body) {
        ...CommentDetails
      }
    }
...
export const SEND_MESSAGE = gql`
  mutation sendMessageForm($content: String!, $receiver: String!){
...
export const MARK_SEEN = gql`
  mutation markSeenMessage($sender: String!){
    markSeenMessage(sender: $sender){
      message
    }
  }
`;